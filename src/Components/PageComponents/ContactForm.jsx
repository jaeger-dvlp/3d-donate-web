...
export default function ContactForm() {
  ...
  return (
    <div className="w-full !z-1 font-pop grid grid-cols-1 gap-16 py-16 px-5 bg-white place-content-start place-items-center">
      <h1 className="p-3 text-center rounded-lg w-full max-w-[15rem] bg-brand-red/10 text-brand-red font-bold text-xl">
        {t('labels.contact-us')}
      </h1>
      <div className="w-full relative overflow-hidden xl:max-w-4xl lg:max-w-4xl max-w-md grid grid-cols-6 place-items-start place-content-start gap-0 rounded-xl border-brand-red border-2 shadow-xl">
        <div className="w-full xl:py-10 lg:py-10 p-5 grid grid-cols-1 place-content-start place-items-start gap-3 bg-brand-red/10 !h-full xl:col-span-2 lg:col-span-2 col-span-full xl:border-r-2 lg:border-r-2 xl:border-b-0 lg:border-b-0 border-r-0 border-b-2 border-brand-red">
          ...
          <div className="w-full flex justify-start content-center gap-x-2">
            <FaMapMarkerAlt className="p-2 self-center text-3xl bg-brand-red/10 rounded-md text-brand-red" />
