...
export default function NotFound() {
  return (
    <>
      <Helmet>
        <title>{Contents.header.notfound.title[i18next.language]}</title>
      </Helmet>
      <div className="w-full fade-in font-pop min-h-screen grid grid-cols-1 gap-3 place-content-center place-items-center pt-32 p-5">
        <img
          src={Images.page404}
          alt="3D Donate 404"
