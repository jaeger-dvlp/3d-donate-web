...
export default function Checkout() {
  ...
  return (
    <>
      <Helmet>
        <title>{Contents.header.checkout.title[i18next.language]}</title>
      </Helmet>
          ...
          >
            <div className="w-full grid grid-cols-1 gap-2 place-content-start place-items-start">
              ...
              <input
                ...
                placeholder={t(
                  'forms.checkout-form.inputs.fullName.placeholder',
                )}
                type="text"
                name="name"
                required
            ...
            <div className="w-full grid grid-cols-1 gap-2 place-content-start place-items-start">
              ...
              <input
                className="w-full border !outline-none ring-brand-red/30 focus:ring-4 ring-0  border-brand-red/70 text-sm placeholder:text-zinc-400/70 text-zinc-600 p-2 rounded-md"
                placeholder={t(
                  'forms.checkout-form.inputs.postCode.placeholder',
                )}
                type="text"
                name="postcode"
                required
            ...
            <div className="w-full grid grid-cols-1 gap-2 place-content-start place-items-start">
              ...
              <select
                ...
                placeholder={t(
                  'forms.checkout-form.inputs.country.placeholder',
                )}
                type="text"
                name="country"
                required
            ...
            <div className="w-full grid grid-cols-1 gap-2 place-content-start place-items-start">
              ...
              <select
                className="w-full bg-white border !outline-none ring-brand-red/30 focus:ring-4 ring-0  border-brand-red/70 text-sm placeholder:text-zinc-400/70 text-zinc-600 h-[2.5rem] p-2 rounded-md"
                placeholder={t(
                  'forms.checkout-form.inputs.province.placeholder',
                )}
                type="text"
                name="province"
                required
              ...
              >
                {json
                  .find(
                    ({ countryName }) =>
                      countryName === checkoutDetails.country,
                  )
